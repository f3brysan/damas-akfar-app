            ...
            <div class="col-12">
                ...
                <br>                               
                    ...
                    3. NEVA : Nilai Evaluasi.</p>
                        ...
                        <a href="<?php echo site_url("dosen/cetak_hasil_ekd/$tahun_ajaran/$nidn/$kodematkul") ?>" class="btn btn-primary waves-effect waves-light"><i class="fa fa-print m-r-5"></i> Cetak KHS</a>
                    </div>
                    </div>
                </div>
            </div>
