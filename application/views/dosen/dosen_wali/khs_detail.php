		...
		<div class="row">
			<div class="col-md-12">
				...
				<table width="100%" border="0">
					<tr>
						<td width="20%" rowspan="3"><img src="assets/images/akfarlogo.png" alt="" width="75px""></td>
						<td width="60%" align="center"><h3>AKADEMI FARMASI SURABAYA</h3></td>
						<td width="20%" rowspan="3">&nbsp;</td>
					</tr>
					<tr>
						<td class="a" align="center">Jl. Ketintang Madya No 81, Surabaya | (031) 8280996 | akfar.sby@gmail.com</td>
					</tr>
					<tr>
					</tr>
				</table>
...
<?php endif ?>
									...
									<tr>
										...
										<td colspan="3" align="center"><?php foreach ($ips as $ips): ?>
											<?php 
 //echo "B : ".$ips['bobot'].'<br>';
echo number_format($ips['bobot'] / $ips['totalsks'], 2) ?>
										<?php endforeach?>
										</td>
									</tr>
...
<tr>
				...
				<div class="text-right">
						<a href="<?php echo site_url("dosen_wali/cetak_khs/$mhs->nim/$tahunajaran->kode") ?>" class="btn btn-primary waves-effect waves-light"><i class="fa fa-print m-r-5"></i> Cetak KHS</a>
                    </div>
