...
<div class="content">
	<table width="100%" border="0">
		<tr>
			<td width="100%" align="center"><img src="assets/images/kop_transkrip.png" alt="" width="600px""></td>
		</tr>
	</table>
	<div class="col-4 offset-2">
		...
		<div class="col-4 offset-2">
			<table width="100%" class='nilai'>
				...
				<tr>
					<td class="a-left" colspan="6"><strong>SEMESTER III</strong> </td>
		...
		<div class="col-4 offset-2">
			<table width="100%" class="pertama">
				<tr>
					<td>&nbsp;</td>
					<td class="a-no">
						Ditetapkan di Surabaya, 2 Oktober 2020
						<br>
						<br>
					</td>
					<td>&nbsp;</td>
				...
				<tr>
					...
					<td rowspan="3" align="center" valign="top"><img src="assets/images/foto_holder_white.png" width="120px"></td>
					<td class="a-no" valign="top">
						WAKIL DIREKTUR I<br />
				...
				<tr>
					<td class="a-no" valign="top">
					<u>Ratih Kusuma Wardani, S.Si., M.Si.</u><br>NIDN. 0719049001</p>
				</td>
				<td class="a-no" valign="top">
				<u>apt. M.A. Hanny Ferry Fernanda, M.Farm</u><br>NIDN. 0726018802</p>
			</td>
		</tr>
	</table>
</div>
