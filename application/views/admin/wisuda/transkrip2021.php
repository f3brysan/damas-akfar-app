...
<div class="content">
	...
	<div class="col-4 offset-2">
		<table width="100%" border="0">
			<tr>
				<td width="100%" align="center" class="a-transkrip"><strong>TRANSKRIP AKADEMIK</strong></td>
			</tr>
		</table>
		<br>
		<div class="col-4 offset-2">
		...
		<div class="col-4 offset-2">
			<table width="100%" class="pertama">
				...
				<tr>
					...
					<td rowspan="3" align="center" valign="top"><img src="assets/images/foto_holder.png" alt="" width="100px"></td>
					<td class="a-no" valign="top">
						DIREKTUR<br />
