...
foreach ($data as $d): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo site_url("admin/hapus_verif_mhs/$d[angkatan]/$kode/$d[nim]") ?>" onclick="return confirm('Anda yakin membatalkan verifikasi dari <?php echo $d['namalengkap']; ?> ?');" data-toggle="tooltip" title="Hapus?" class="btn btn-link"><em class="fa fa-trash"></em></a>
                                </td>
                            </tr>
                            <?php endforeach;?>
                            <?php endif?>
...
foreach ($jumlah as $d): ?>
                            <tr>
                                ...
                                <td><?php echo $d['angkatan'] ?></td>
                                <td>
                                    <a href="<?php echo site_url("admin/permit_krs/$d[angkatan]/$kode/$d[nim]") ?>" data-toggle="tooltip" title="Lihat Data" class="btn btn-link"><em class="fa fa-check"></em> Ijinkan</a>
                                </td>
                            </tr>
                            <?php endforeach;?>
                        </tbody>
