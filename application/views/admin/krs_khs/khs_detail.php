...
<tr>
				...
				<div class="text-right">
						<a href="<?php echo site_url("admin/cetak_khs/$mhs->nim/$tahunajaran->kode") ?>" class="btn btn-primary waves-effect waves-light"><i class="fa fa-print m-r-5"></i> Cetak KHS</a>
                    </div>
