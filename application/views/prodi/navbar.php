                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="<?php echo site_url("prodi/data_pjmk") ?>">Data Dosen PJMK</a></li>
                                    <li><a href="<?php echo site_url("prodi/proposal_kti") ?>">Data Proposal KTI</a></li>
                                    <li><a href="<?php echo site_url("prodi/kti") ?>">Data Peserta KTI</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="javascript: void(0);"><i class="fi-layers"></i> <span> Master Studi</span> <span class="menu-arrow"></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                                    ...
                                    <li><a href="<?php echo site_url("prodi/kpm") ?>">Data KPM</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="javascript: void(0);"><i class="fi-layers"></i> <span> EKD </span> <span class="menu-arrow"></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="<?php echo site_url("prodi/hasil_ekd") ?>">Hasil EKD</a></li>
                                    <li><a href="<?php echo site_url("prodi/ekd") ?>">Master Data EKD</a></li>
                                    <li><a href="<?php echo site_url("prodi/soal_ekd") ?>">Master Soal EKD</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
