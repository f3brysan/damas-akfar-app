                        ...
                        <tbody>
                            ...
                            foreach ($unapprove_list as $u): ?>
                                <tr>
                                    ...
                                    <td><?php if ($u['bukti_perpus'] == NULL): ?>
                                    <a><span class="badge badge-danger"> Belum</span> </a>                                    
                                        <?php else: ?>
                                    <a href="<?php echo base_url();?>uploads/yudisium/<?php echo $u['bukti_perpus'] ?>" target="_blank"><span class="badge badge-success"> Lihat</span></a>
                                    <?php endif ?></td>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?php echo site_url("perpus/approve_mhs_kti/$kode/$u[nim]") ?>" class="btn btn-xs btn-success"><i class="fa fa-check"></i> Ijinkan</a>
                                        <?php else: ?>
                                        <a href="<?php echo site_url("perpus/unapprove_mhs_kti/$kode/$u[nim]") ?>" class="btn btn-xs btn-danger"><i class="fa fa-close"></i> Tolak</a>
                                    <?php endif ?></td>                                                                      
                                    </tr>
                                <?php endforeach;?>
                            </tbody>
                        ...
                        <tbody>
                            ...
                            foreach ($approve_list as $a): ?>
                                <tr>
                                    ...
                                    <td><?php if ($a['bukti_perpus'] == NULL): ?>
                                   <a><span class="badge badge-danger"> Belum</span> </a>                                    
                                        <?php else: ?>
                                    <a href="<?php echo base_url();?>uploads/yudisium/<?php echo $a['bukti_perpus'] ?>" target="_blank"><span class="badge badge-success"> Lihat</span></a>
                                    <?php endif ?></td>
                                    <td><?php $date = date_create($a['approve_at']);
                                    echo date_format($date, "d/M/y H:i"); ?> </td>  
                                    <td>
                                        <?php if ($a['status'] == NULL): ?>                                       
                                        <a href="<?php echo site_url("perpus/approve_mhs_kti/$a[nim]/$kode") ?>" class="btn btn-xs btn-success"><i class="fa fa-check"></i> Ijinkan</a>
                                        <?php else: ?>
                                        <?php $kode = substr($a['id'],0,7); ?>
                                        <a href="<?php echo site_url("perpus/unapprove_mhs_kti/$kode/$a[nim]") ?>" class="btn btn-xs btn-danger"><i class="fa fa-close"></i> Tolak</a>
                                    <?php endif ?></td>                                                                        
                                    </tr>
                                <?php endforeach;?>
                            </tbody>
