                ...
                <div class="slimscroll-menu" id="remove-scroll">
                    ...
                    <div id="sidebar-menu">
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li>
                                <a href="<?php echo site_url('laboran'); ?>">
                                    <i class="fi-air-play"></i><span class="badge badge-danger badge-pill pull-right">7</span> <span> Dashboard </span>
                                </a>
                            </li>
                            <li>
                                <a href="javascript: void(0);"><i class="fi-layers"></i> <span> Master Data Bebas KTI Yudisium</span> <span class="menu-arrow"></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="<?php echo site_url("perpus/data_kti_yudisium") ?>">Data Bebas Perpus Yudisium</a></li>
                                    <!-- <li><a href="<?php echo site_url("perpus/bebas_lab_approved_list") ?>">Data Mahasiswa Bebas Lab</a> --></li>
                                </ul>
                            </li>
                            <!-- <li>
                        ...
                        <ul class="list-unstyled topbar-right-menu float-right mb-0">
                            ...
                            <li class="dropdown notification-list">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated profile-dropdown ">
                                    ...
                                    <!-- item-->
                                    <!-- item-->
                                    <a href="<?php echo site_url("perpus/gantipassword") ?>" class="dropdown-item notify-item">
                                        <i class="fi-power"></i> <span>Ganti Password</span>
                                    </a>
                                    <a href="<?php echo site_url("perpus/logout") ?>" class="dropdown-item notify-item">
