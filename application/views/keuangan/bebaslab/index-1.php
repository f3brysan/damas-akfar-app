                        ...
                        <tbody>
                            ...
                            foreach ($yudisum as $y): ?>
                                <tr>
                                    ...
                                    <?php endif ?></td>                                    
                                    <td>
                                       <a href="<?php echo site_url("keuangan/list_lab_yudisum/$y[kode]") ?>" data-toggle="tooltip" title="Lihat Data" class="btn btn-link"><span class="fa fa-folder-open"> Lihat Data</span></a>
                                        </td>
                                    </tr>
                                <?php endforeach;?>
                            </tbody>
