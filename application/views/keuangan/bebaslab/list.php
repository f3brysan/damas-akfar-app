                            ...
                            foreach ($bebas_lab as $lab): ?>
                                <tr>
                                    ...
                                    <span class="badge badge-danger"> Belum</span> 
                                        <?php else: ?>
                                    <span class="badge badge-success"> Sudah</span> 
                                    <?php $date = date_create($lab['approve']);
                                    echo date_format($date, "d/M/y H:i"); ?> 
                                    <?php endif ?></td>  
                                    <td>
                                        <?php if ($lab['jenis_lab'] == NULL): ?>
                                        <a href="<?php echo site_url("keuangan/spp_allow/$lab[lab_id]") ?>" class="btn btn-xs btn-success"><i class="fa fa-check"></i> Ijinkan</a>
                                        <?php else: ?>
                                        <a href="<?php echo site_url("keuangan/hapus_data_bebas_lab/$lab[lab_id]/") ?><?php $kode = substr($lab['id'],0,7) ?><?php echo $kode ?>" class="btn btn-xs btn-danger"><i class="fa fa-close"></i> Tolak</a>
                                    <?php endif ?></td>                                                                      
                                    </tr>
                                <?php endforeach;?>
                            </tbody>
            ...
            <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="edit-data" class="modal fade">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form class="form-horizontal" action="<?php echo base_url('keuangan/injek_data_bebas_lab') ?>" method="post" enctype="multipart/form-data" role="form">
