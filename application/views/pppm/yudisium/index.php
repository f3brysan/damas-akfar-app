                        ...
                        <tbody>
                            ...
                            foreach ($yudisum as $y): ?>
                                <tr>
                                    ...
                                    <td>
                                       <a href="<?php echo site_url("pppm/waiting_list_kti/$y[kode]") ?>" data-toggle="tooltip" title="Lihat Data" class="btn btn-link"><span class="fa fa-folder-open"> Lihat Data</span></a>
                                        </td>
                                    </tr>
                                <?php endforeach;?>
                            </tbody>
