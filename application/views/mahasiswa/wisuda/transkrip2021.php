...
@page { margin: 0cm 1cm; }.
 ...
 <div id="watermark"><h1 style="font-size: 72">D  R  A  F  T</h1></div>
<div class="content">
	<table width="100%" border="0">
		<tr>
			<td width="100%" align="center"><img src="assets/images/kop_2021.png" alt="" width="600px""></td>
		</tr>
	</table>
	<div class="col-4 offset-2">
		<table width="100%" border="0">
			<tr>
				<td width="100%" align="center" class="a-transkrip"><strong>TRANSKRIP AKADEMIK SEMENTARA</strong></td>
			</tr>
		</table>
		<br>
		<div class="col-4 offset-2">
			<table width="100%" class="pertama">
				...
				<tr>
					...
					<td>&nbsp;</td>
					<td>&nbsp;</td>
					<td><?php if ($no_surat['0']['no_pin'] != null): ?>
						Nomor PIN
						<?php else: ?>
						&nbsp;
						<?php endif?>
		...
		<div class="col-4 offset-2">
			<table width="100%" class='nilai'>
				...
				<tr>
					<td colspan="6"><strong>SEMESTER I </strong></td>
					<td class="a-left" colspan="6"><strong>SEMESTER IV</strong> </td>
				</tr>
				<tr>
					<td class="a">1</td>
				...
				<tr>
				  <td colspan="6"><strong>SEMESTER II</strong></td>
				  <td class="a">14</td>
				...
				<tr>
				  ...
				  <td class="a"><?php echo $dua['0']['bobot'] ?></td>
					<td class="a">15</td>
					<td class="a"><?php echo $empat['14']['kodematkul'] ?></td>
					<td class="a-left"><?php echo $empat['14']['nama'] ?></td>
					<td class="a"><?php echo $empat['14']['sks'] ?></td>
					<td class="a"><?php echo $empat['14']['huruf'] ?></td>
					<td class="a"><?php echo $empat['14']['bobot'] ?></td>
				</tr>
				<tr>
				  <td class="a">2</td>
				  ...
				  <td class="a"><?php echo $dua['1']['bobot'] ?></td>
					<td colspan="6"><strong>SEMESTER V</strong> </td>
				</tr>
				<tr>
				  <td class="a">3</td>
				...
				<tr>
				  ...
				  <td class="a"><?php echo $dua['10']['bobot'] ?></td>
					<td colspan="6"><strong>SEMESTER VI</strong> </td>
				</tr>
				<tr>
				  <td class="a">12</td>
				...
				<tr>
					<td colspan="6" class="a"><strong>SEMESTER III</strong></td>
				...
				<tr>
				  ...
				  <td class="a"><?php echo $tiga['0']['bobot'] ?></td>
					<td colspan="6" rowspan="17" valign="top" style="border:0px">
						<table width="100%" class="nilai">
							<tr>
								<td colspan="2" class="a"><strong>JUDUL KARYA TULIS ILMIAH</strong></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td class="a">
									<?php $ipk_pembulatan = number_format($ipk['0']['bobot'] / $ipk['0']['totalsks'], 2);  ?>	
									<?php if ($ipk_pembulatan >= 3.51): ?>
									Lulus dengan Pujian
									<?php elseif ($ipk_pembulatan >= 3.01): ?>
									Lulus dengan Sangat Memuaskan
									<?php elseif ($ipk_pembulatan >= 2.76): ?>
						...
						<table width="100%" class="nilai">
							<tr>
								<td colspan="3" class="a"><strong>Konversi Nilai</strong></td>
							</tr>
							<tr>
								<td width="40%" class="a">Nilai Mutlak </td>
								<td width="40%" class="a">Nilai Relatif </td>
								<td width="40%" class="a">Bobot Nilai </td>
							</tr>
							<tr>
								<td class="a">&gt;= 76 </td>
								<td class="a">A</td>
		...
		<div class="col-4 offset-2">
			<table width="100%" class="pertama">
				<tr>
					<td>&nbsp;</td>
					<td class="a-no">
						Ditetapkan di Surabaya, 30 September 2021
						<br>
						<br>
					</td>
					<td>&nbsp;</td>
				...
				<tr>
					<td class="a-no" valign="top">
						WAKIL DIREKTUR I<br />
						BIDANG AKADEMIK DAN KEMAHASISWAAN
					</td>
					<td rowspan="3" align="center" valign="top"><img src="assets/images/foto_holder.png" alt="" width="110px"></td>
					<td class="a-no" valign="top">
						DIREKTUR<br />
				...
				<tr>
					<td class="a-no" valign="top">
					<u>M.A. Hanny Ferry Fernanda, S.Farm., M.Farm., Apt.</u><br>NIDN. 0726018802</p>
				</td>
				<td class="a-no" valign="top">
					<u>Ninik Mas Ulfa, S.Si., Apt., Sp-FRS.</u><br>NIDN.
				0701027504</p>
			</td>
		</tr>
	</table>
