			...
			<div class="col-md-12">
				<div class="card-box table-responsive">
					<table width="100%" border="0">
						<tr>
							<td width="100%" align="center"><img src="assets/images/kop_2021.png" alt="" width="680px""></td>
						</tr>
					</table>
					<div class="row">
						...
						<div class="col-4 offset-2">
							<table width="100%" border="0" class="b">
								...
								<tr>
									<td>Semester</td>
									<td>:</td>
									<td><?php echo $semester_selected['0']['semester'] ?></td>
									<td>&nbsp;</td>
									<td>DPA</td>
									<td>:</td>
									<td><?php if (count($dosenwalimhs) > 0): ?>
...
foreach ($pickedkrs as $pk): ?>
						...
						<div class="row">
							<?php $date = date_create($validasi->tanggal_disetujui) ?>	
							...
							<table width="100%" border="0" class="b" >
								...
								?>								
								<img src="uploads/qrcode/qrcode_krs_<?php echo $username; ?>_<?php echo $validasi->tahun_ajaran ?>.png" alt="" width="100px"">
							<?php //endforeach ?></td>
