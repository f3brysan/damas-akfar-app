				...
				<div class=" row">
					...
					<div class="col-4 offset-2">
						<table width="100%" border="0">
							<tr>
								<td width="10%">&nbsp;</td>
								<td align="center" class="judul"><?php echo $kti->judul; ?></td>
								<td width="10%">&nbsp;</td>
							</tr>
							<tr>
								<td>&nbsp;</td>
								<td align="center" class="judul"><?php if ($kti->sub_judul !== null): ?>
						...
						<table width="100%" border="0">
							...
							<tr>
								<td>&nbsp;</td>
								<td align="center" class="12bold">Karya Tulis Ilmiah ini telah diperiksa dan disetujui isi serta susunannya untuk dapat diuji dan dipertahankan dihadapan Tim Penguji Karya Tulis Ilmiah Jenjang Pendidikan Diploma III Akademi Farmasi Surabaya
								</td>
								<td>&nbsp;</td>
							</tr>
							<tr>
