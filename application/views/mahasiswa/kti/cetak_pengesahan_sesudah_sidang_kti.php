				...
				<div class=" row">
					...
					<div class="col-4 offset-2">
						...
						<table width="100%" border="0">
							...
							<tr>
								<td>&nbsp;</td>
								<td align="center" class="12bold">Karya Tulis Ilmiah ini telah diuji dan disetujui<br>
						...
						<div align="center">
							...
							<table width="100%" border="0">
								...
								<tr>
									<td>&nbsp;</td>
									<td align="center" class="12bold"><u><?php echo $dosen['2']['nama'] ?>, <?php echo $dosen['2']['gelarbelakang'] ?></u><br />NIDN/NUP. <?php echo $dosen['2']['rel_nidn'] ?></td>
									<td>&nbsp;</td>
								</tr>
							</table>
							<?php else: ?>
