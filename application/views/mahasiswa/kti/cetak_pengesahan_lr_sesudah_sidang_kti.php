				...
				<div class=" row">
					...
					<div class="col-4 offset-2">
						...
						<table width="100%" border="0">
							...
							<tr>
								<td>&nbsp;</td>
								<td align="center" class="12bold">Karya Tulis Ilmiah (Literature Review) ini telah diuji dan disetujui<br>
									dihadapan Tim Penguji Karya Tulis Ilmiah Jenjang Pendidikan<br>
						...
						<div align="center">
							...
							<?php if (is_array($dosen) && count($dosen) >= 3): ?>
							<table width="100%" border="0">
								<tr>
								...
								<tr>
									<td align="center"><img src="uploads/qrcode/qrcode_kti_after_<?php echo $dosen['0']['qrcode_id']; ?>.png" alt="" width="100px""></td>
									<td height="90px">&nbsp;</td>
									<td align="center"><img src="uploads/qrcode/qrcode_kti_after_<?php echo $dosen['1']['qrcode_id']; ?>.png" alt="" width="100px""></td>
								</tr>
								<tr>
							...
							<table width="100%" border="0">
								<tr>
									<td width="20%">&nbsp;</td>
									<td align="center" class="12bold">Penguji</td>
									<td width="20%">&nbsp;</td>
								</tr>
								<tr>
									<td>&nbsp;</td>
									<td align="center"><img src="uploads/qrcode/qrcode_kti_after_<?php echo $dosen['2']['qrcode_id']; ?>.png" alt="" width="100px""></td>
									<td>&nbsp;</td>
								</tr>
								<tr>
									<td>&nbsp;</td>
									<td align="center" class="12bold"><u><?php echo $dosen['2']['nama'] ?>, <?php echo $dosen['0']['gelarbelakang'] ?></u><br />NIDN/NUP. <?php echo $dosen['2']['rel_nidn'] ?></td>
									<td>&nbsp;</td>
								</tr>
							</table>
							<?php else: ?>
							...
							<table width="100%" border="0">
								...
								<tr>
									<td>&nbsp;</td>
									<td align="center" class="12bold"><u><?php echo $dosen['1']['nama'] ?>, <?php echo $dosen['0']['gelarbelakang'] ?></u><br />NIDN/NUP. <?php echo $dosen['1']['rel_nidn'] ?></td>
									<td>&nbsp;</td>
								</tr>
							</table>
							<?php endif ?>
