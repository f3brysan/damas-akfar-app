				...
				<div class=" row">
					...
					<div class="col-4 offset-2">
						<table width="100%" border="0">
							...
							<tr>
								<td>&nbsp;</td>
								<td align="center" class="12bold" ><?php if ($kti->sub_judul !== null): ?>
						...
						<table width="100%" border="0">
							...
							<tr>
								<td>&nbsp;</td>
								<td align="center" class="12bold">Karya Tulis Ilmiah (Literature Review) ini telah diperiksa dan<br> 
								disetujui isi serta susunannya untuk dapat diuji dan dipertahankan<br>
								dihadapan Tim Penguji Karya Tulis Ilmiah<br>
