				...
				<div class=" row">
					...
					<div class="col-4 offset-2">
						...
						<table width="100%" border="0">
							...
							<tr>
								<td>&nbsp;</td>
								<td align="center" class="12bold">Proposal Karya Tulis Ilmiah (literature review) ini telah diuji dan disetujui
						...
						<div align="center">
							...
							<table width="100%" border="0">
								...
								<tr>
									<td align="center"><img src="uploads/qrcode/qrcode_proposal_kti_after_<?php echo $dosen['0']['qrcode_id']; ?>.png" alt="" width="100px""></td>
									<td height="90px">&nbsp;</td>
									<td align="center"><img src="uploads/qrcode/qrcode_proposal_kti_after_<?php echo $dosen['1']['qrcode_id']; ?>.png" alt="" width="100px""></td>
								</tr>
								<tr>
							...
							<table width="100%" border="0">
								...
								<tr>
									<td>&nbsp;</td>
									<td align="center"><img src="uploads/qrcode/qrcode_proposal_kti_after_<?php echo $dosen['2']['qrcode_id']; ?>.png" alt="" width="100px""></td>
									<td>&nbsp;</td>
								</tr>
								<tr>
									<td>&nbsp;</td>
