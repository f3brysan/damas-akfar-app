                            ...
                            <form role="form" action="" method="post" enctype="multipart/form-data">
                                <div class="form-row">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="password" class="form-control" id="validationDefault01" name="newpassword" required>
                                    </div>
                                    <div class="col-md-12 mb-3">
                                        <label for="validationDefault02">Retype New Password</label>
                                        <input type="password" class="form-control" id="validationDefault01"  name="newpassword2" required>
                                    </div>
